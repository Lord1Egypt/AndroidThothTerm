#ifndef THOTHTERM_REGISTRATION_H
#define THOTHTERM_REGISTRATION_H
/*
...
int thothterm_log_print(int prio, const char *fmt, ...);

#define LOGE(...) do { thothterm_log_print(ANDROID_LOG_ERROR, __VA_ARGS__); } while(0)

#endif /* ndef THOTHTERM_REGISTRATION_H */
