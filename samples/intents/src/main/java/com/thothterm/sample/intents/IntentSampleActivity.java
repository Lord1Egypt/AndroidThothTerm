package com.thothterm.sample.intents;
...
public class IntentSampleActivity extends AppCompatActivity {
    ...
    private static final String ARGUMENT_WINDOW_HANDLE = "com.thothterm.WindowHandle";
    private static final String ARGUMENT_SHELL_COMMAND = "com.thothterm.Command";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        addClickListener(R.id.runScript, v -> {
            /* Intent for opening a new window and running the provided
               ...
               com.thothterm.permission.RUN_SCRIPT in your manifest
               to use */
